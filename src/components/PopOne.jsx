  ...
  useEffect(() => {
    ...
    return (
        <div className="popup-container">
          ...
          <div className="popup">
            <h3>{language === 'es' ? 'Full Stack Development' : 'Desarrolladora Full Stack'}<i className="fa-solid fa-code" style={{marginLeft:'1rem'}}></i></h3>
            ...
            <h3>{language === 'es' ? 'Certifications' : 'Certificaciones'}<i className="fa-solid fa-certificate" style={{marginLeft:'1rem'}}></i> </h3>
            <div className="icons pop-icons" style={{marginTop:'0'}}>
